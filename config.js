...
module.exports = {
    ...
    RG: process.env.RG || '94753240198-1632403322@g.us',
    PASSWORD: process.env.PASSWORD || '',
    BOT_INFO: process.env.BOT_INFO || 'PISSEK;PISSEK;94753240198;https://i.ibb.co/QfHrvxW/1eef8858db9c.jpg;https://chat.whatsapp.com/ClQqwfJkoM86Sqg35xtVsR',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'PISSEK',
    ...
    SUDO: process.env.SUDO || '94753240198,0',
